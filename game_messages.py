...
class GameMessages():
    ...
    START = "Добро пожаловать в новейшую игру всех времен и народов. Для начала игры нажмите 'new game'."
    ...
    BONUS_GAME_MES = "Поздравляем, вам доступна бонусная игра. Теперь вам необходимо загадать число от 1 до 100, а ZX-Spectrum будет его отгадывать.\n"
